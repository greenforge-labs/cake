...
template <typename DerivedSessionType> struct SimpleNodeSession : cake::Session {
...
class SimpleNodeBase : public cake::BaseNode<"simple_node", SessionType, extend_options> {
    static_assert(
  ...
  public:
    explicit SimpleNodeBase(const rclcpp::NodeOptions &options)
        : cake::BaseNode<"simple_node", SessionType, extend_options>(options) {}
